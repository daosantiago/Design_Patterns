...
if __name__ == '__main__':
    ...
    # nota_com_builder = Nota_fiscal(
    #     'Nota com Builder ltda',
    #     '012345678901234',
    #     itens,
    #     date.today(),
    #     '')

    print 'Nota sem Builder'
    ...
    #print ''
    #print 'Nota com Builder'
    #print nota_com_builder.razao_social
    #print nota_com_builder.cnpj
    #print nota_com_builder.data_de_emissao
    #print nota_com_builder.detalhes